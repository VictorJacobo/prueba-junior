<x-app-layout>
    <div class="container mx-auto px-4 py-8 h-full">
        ...
        <div class="flex justify-between items-center mb-6 px-4 sm:px-0">
            ...
            <x-icon-button href="{{ route('categories.create') }}" icon="<path fill-rule='evenodd' d='M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z' clip-rule='evenodd' />">
                Nueva Categoría
            </x-icon-button>
        </div>
